...
export type Relation = "heads"|"dependents";
...
export class RelationSet extends NxBaseClass {
  ...
  constructor(private readonly token: BaseToken,
              private readonly partner: Relation) {
    super("RelationSet");
  }
  ...
  map<T>(callback: (item: RelationItem, index?: number) => T): T[] {
