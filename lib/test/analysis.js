...
describe("Analysis", function () {
    describe("invalid intializer", function () {
        it("throw a NotatrixError", function () {
            expect(function () { var a = new Analysis(); }).to.throw(E.NotatrixError);
        });
    });
    var s = new Sentence();
    var data = [
    ...
    _.each(data, function (d) {
        describe("valid intializer", function () {
            ...
            it("return formats correctly", function () {
                ...
                t.params = d.inParams;
                var a = t.analysis;
                expect(function () { return a.conllu; })
                    .to.throw(E.NotatrixError);
                a.cg3;
                t.sentence.index();
                expect(function () { return a.conllu; }).to.throw(E.NotatrixError);
                a.cg3;
            });
        });
    });
    describe("modify contents", function () {
        it("handles (insert|remove|move)SubTokenAt() and (push|pop)SubToken", function () {
            var s = new Sentence();
            var t0 = new Token(s);
            var t1 = new Token(s);
            var t2 = new Token(s);
            var t3 = new Token(s);
            var t4 = new Token(s);
            var a0 = new Analysis(t0, { form: "zeroth" });
            var a1 = new Analysis(t1, { form: "first" });
            var a2 = new Analysis(t2, { form: "second" });
            var a3 = new Analysis(t3, { form: "third" });
            var a4 = new Analysis(t4, { form: "fourth" });
            t0.analysis = a0;
            t1.analysis = a1;
            t2.analysis = a2;
            t3.analysis = a3;
            ...
            expect(function () { a0.insertSubTokenAt(); }).to.throw(E.NotatrixError);
            expect(function () { a0.insertSubTokenAt({}); }).to.throw(E.NotatrixError);
            expect(function () { a0.insertSubTokenAt(null); }).to.throw(E.NotatrixError);
            expect(function () { a0.insertSubTokenAt(undefined); })
                .to.throw(E.NotatrixError);
            expect(function () { a0.insertSubTokenAt("x"); }).to.throw(E.NotatrixError);
            expect(function () { a0.insertSubTokenAt(0); }).to.throw(E.NotatrixError);
            expect(function () { a0.insertSubTokenAt(0, {}); }).to.throw(E.NotatrixError);
            expect(function () { a0.insertSubTokenAt(0, null); }).to.throw(E.NotatrixError);
            expect(function () { a0.insertSubTokenAt(0, undefined); })
                .to.throw(E.NotatrixError);
            expect(function () { a0.insertSubTokenAt(0, a1); }).to.throw(E.NotatrixError);
            ...
            expect(function () { a3.insertSubTokenAt(0, t0); }).to.throw(E.NotatrixError);
            expect(function () { a3.insertSubTokenAt(0, t1); }).to.throw(E.NotatrixError);
            ...
            expect(ignoreAfterLemma(s.conllu))
                .to.equal("1-4 zeroth _ 1 second second 2 third third 3 first first 4 fourth fourth");
            ...
            expect(ignoreAfterLemma(s.conllu))
                .to.equal("1-3 zeroth _ 1 second second 2 first first 3 fourth fourth");
            ...
            var ret = a0.pushSubToken(t1).pushSubToken(t2).pushSubToken(t3).popSubToken();
            a0.pushSubToken(t4);
